...
- 2026-02-25: Fixed unmanaged CoroutineScope in PaymentService.kt - added externalScope parameter, SupervisorJob, and destroy() method for proper lifecycle management (Issues #400, #401)
